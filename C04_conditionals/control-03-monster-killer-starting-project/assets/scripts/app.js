...
function attackMonster(attackMode) {
    const maxDamage = attackMode === ATTACK_MODE ? ATTACK_VALUE : STRONG_ATTACK_VALUE;
    const logEvent = attackMode === ATTACK_MODE ? LOG_EVENT_PLAYER_ATTACK : LOG_EVENT_PLAYER_STRONG_ATTACK;
